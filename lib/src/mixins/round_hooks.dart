...
mixin RoundHooks<T extends ConsumerStatefulWidget> on ConsumerState<T> {
  ...
  // Voting
  late final int? roundEndUtc = _watchThen((game) => game.gameRoom.roundEndUTC);

  late final Duration? timeRemaining = ref.watch(timerNotifierProvider(roundEndUtc)).valueOrNull?.timeRemaining;
